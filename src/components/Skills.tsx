...
import pinia from '../assets/pinia.webp'
        ...
        <div className=" md:grid md:grid-cols-2   text-neutral-300 text-lg font-sans">
          ...
          <motion.div
            ...
            <ul className="flex flex-wrap  justify-center gap-8 mt-4">
              ...
              <li className="flex flex-col items-center">
                <img src={vue} alt="Vue.js" className='w-12 h-12' />
                <span className="text-white mt-2 text-center">Vue.js</span>
              </li>
              <li className="flex flex-col items-center">
                <img src={redux} alt="Redux" className='w-12 h-12' />
                <span className="text-white mt-2 text-center">Redux</span>
              </li>
              <li className="flex flex-col items-center">
                <img src={pinia} alt="pinia" className='w-12 h-12' />
                <span className="text-white mt-2 text-center">Pinia</span>
              </li>
